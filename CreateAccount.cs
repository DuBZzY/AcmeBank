    ...
    public partial class CreateAccount : Form
    {
        ...
        private void btnRegisterAccount_Click(object sender, EventArgs e)
        {
            if(inputValidation())
            {
                ...
                {
                    currentAccount.openCurrentAccount(lastAccountID + 1); // I would allow deposit amount to be passed through as well, but currently do not as interface requires this format.
                    lastAccountID++;
                    ClearForm();
